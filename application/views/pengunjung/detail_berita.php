...
<head>
	...
	<meta name="title" content="<?php echo $berita['judul_berita']; ?>">
	<meta name="description" content="">
	<meta name="author" content="antoniusardyyansah@gmail.com">
	<meta name="keywords" content="<?php echo $berita['judul_berita']; ?>">

	<meta property="og:title" content="<?php echo $berita['judul_berita']; ?>" />
	<meta property="og:url" content="<?php echo base_url("berita/detail/".$berita['url_berita']); ?>" />
	...
	<title><?php echo $berita['judul_berita']; ?> - SMK Taruna Bangsa Ciamis</title>
	<style type="text/css">
footer {
						...
						<div class="col-md-10 col-md-offset-1">
							<div class="blog-items">
								...
								<div class=" single-item">
									<div class="item">
										<div class="thumb">
											<a href="#"><img class="img-responsive" src="<?php echo base_url("assets/admin/img/berita/".$berita['foto_berita']); ?>" alt="Thumb"></a>
											<div class="date">
												<h4><span><?php echo date("d",strtotime($berita['tgl_berita'])) ?></span><?php echo date("M",strtotime($berita['tgl_berita'])) ?>, <?php echo date("Y",strtotime($berita['tgl_berita'])) ?></h4>
											</div>
										</div>
